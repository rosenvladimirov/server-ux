...
class BaseSynchro(models.TransientModel):
    ...
    def synchronize(self, server, object):
        ...
        for dt, id, action in sync_ids:
            ...
            if object.search_domain != "[]":
                if not destination_inverted:
                    id2 = pool_dest.env[object.model_id.model].search(object.search_domain)
                else:
                    id2 = pool_dest.get(object.model_id.model).search(object.search_domain)
